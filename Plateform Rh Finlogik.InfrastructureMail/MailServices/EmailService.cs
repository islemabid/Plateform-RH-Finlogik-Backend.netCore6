           ...
           <h1>
               ...
               <tr>
                 <td class='bg_white' style='padding: 1em 2.5em 0 2.5em;text-align: center;'><div class='cls_002'>
                     <span class='cls_002'>Reset Password !</span>
                   </div>
  <br>
                   <div class='cls_003'>
                     <span class='cls_003'>
" + mailRequest.Body + @", We cannot simply send  your old password. A unique link to reset your
                    password has been generated for you. To reset your password, click the following link and follow the instructions. </span>
                          <a href='http://localhost:4200/Forgotpasword/" + mailRequest.ToEmail + @" ' style = 'background:#c7db1e;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;' > Reset
                                            Password </ a ></span>
                   </div>              <br>
