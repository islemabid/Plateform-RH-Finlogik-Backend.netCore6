...
namespace Plateform_RH_Finlogik.Api.Controllers
{
    ...
    public class ContratController : ControllerBase
    {
        ...
        [HttpGet("{id}", Name = "GetContratById"),Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Ressources Humaines")]
        ...
        [HttpPost(Name = "AddContrat"), Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Ressources Humaines")]
        ...
        [HttpPut(Name = "UpdateContrat"),Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Ressources Humaines")]
        ...
        [HttpDelete("{id}", Name = "DeleteContrat"), Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Ressources Humaines")]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesDefaultResponseType]
