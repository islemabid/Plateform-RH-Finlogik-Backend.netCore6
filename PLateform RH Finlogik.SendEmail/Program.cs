...
using PLateform_RH_Finlogik.SendEmail.Helper;
...
try
{
    using (SqlConnection con = new SqlConnection("Server=localhost;Database=PlateFormRHFinlogik;Trusted_Connection=True;"))
    {
